...
| M9 | Notifications + push | **in-app done 2026-08-24** — §9.2's centre, badge, per-category preferences and row-to-target routing, reopened by the 1.4.1 audit as MT-005. Push waits on `google-services.json`, which still names the pre-rename package |
