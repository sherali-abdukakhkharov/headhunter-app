...
| M9 | Notifications + push | **done 2026-08-24** — §9.2's centre, badge, per-category preferences and row-to-target routing (1.10.0), then push: device registration, tap-to-route from a closed app and a foreground badge refresh (1.11.0). Reopened by the 1.4.1 audit as MT-005 |
